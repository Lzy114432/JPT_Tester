...
## Configuration Tips
Store environment-specific machine settings outside source control; use the samples under `Ewan.Model/Config` as the starting point for new stations.
